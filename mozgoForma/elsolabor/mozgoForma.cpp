...
#define SHOULDER_RADIUS 0.55
#define JOINT_RADIUS 0.55
int light_flag = 0;
...
{
	glPushMatrix();
	glScalef(1.0*TORSO_RADIUS, 0.1, 1.0*TORSO_RADIUS);
	gluSphere(h, 1.0, 10, 10);
	glPopMatrix();
}
...
{
	//light 1
	GLfloat light_ambient1[] = { 0.0, 0.0, 1.0, 0.0 };
	GLfloat light_diffuse1[] = { 0.5, 1.5, 1.0, 1.0 };
	GLfloat light_specular1[] = { 1.0, 1.0, 0.5, 1.0 };
	...
	GLfloat light_diffuse2[] = { 1.0, 1.0, 0.5, 1.0 };
	GLfloat light_specular2[] = { 1.0, 0.5, 1.0, 1.0 };
	...
	//light 4
	GLfloat light_ambient4[] = { 0.0, 1.0, 0.0, 1.0 };
	GLfloat light_diffuse4[] = { 1.0, 1.0, 0.5, 1.0 };
